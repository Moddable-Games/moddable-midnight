...
export type ImpureCircuits<PS> = {
  ...
  mintMandate(context: __compactRuntime.CircuitContext<PS>,
              holder_0: { bytes: Uint8Array }): __compactRuntime.CircuitResults<PS, Uint8Array>;
  payOut(context: __compactRuntime.CircuitContext<PS>,
         amount_0: bigint,
         holder_0: { bytes: Uint8Array }): __compactRuntime.CircuitResults<PS, []>;
}
...
export type Ledger = {
  ...
  readonly mandateColor: Uint8Array;
